...
$string['modulename'] = 'Certificate - Quiz';
...
$string['summaryofattempts'] = 'Exam Certificate';
...
$string['cutoffdate'] = 'Cut off date and time';
$string['mingrade'] = 'Minimum grade to obtain a certificate (%)';
$string['certheading'] = 'Exam Certificate';
$string['forumgrades'] = 'Include forum participation in grade';
$string['forumpercent'] = 'Percentage of total grade allocated to forum participation';