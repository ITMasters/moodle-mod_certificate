...
class mod_certificate_mod_form extends moodleform_mod {
    ...
    function definition() {
        ...
        $mform->addElement('text', 'mingrade', get_string('mingrade','certificate'));
        $mform->setType('mingrade', PARAM_INT);

        $mform->addElement('checkbox','forumgrades', get_string('forumgrades','certificate'));
        $mform->setType('forumgrades', PARAM_BOOL);

        $mform->addElement('text', 'forumpercent', get_string('forumpercent','certificate'));
        $mform->setType('forumpercent', PARAM_INT);

        $mform->addElement('date_time_selector', 'cutoffdate', get_string('cutoffdate','certificate'));
        $mform->setType('cutoffdate', PARAM_INT);
