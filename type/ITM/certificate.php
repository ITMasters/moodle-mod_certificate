...
if (checkdate(certificate_get_date($certificate, $certrecord, $course))) {

certificate_print_text($pdf, $x, $y + 109, 'C', 'carlito', '', 14, 'Completed: ' . var_dump(checkdate(certificate_get_date($certificate, $certrecord, $course))));
